...
namespace Core.Objects.Properties
{
    ...
    public class DamagableObject : Property
    {
        ...
        /// <summary>
        /// Устанавливает состояние оглушения, также может отключать подконтрольный 
        /// коллаидер.
        /// </summary>
        /// <param name="isStunned"> Оглушен ли объект. </param>
        /// <param name="disableCollider"> Отключать ли коллаидер. </param>
    ...
    /// <summary>
    /// Структура информации о повреждениях.
    /// </summary>
    [System.Serializable]
